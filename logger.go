...
func (l *Logger) Trace(v ...interface{}) {
	if l.lv <= LevelTrace {
		l.lg.Output(3, fmt.Sprintf("[T] %s", fmt.Sprintln(v...)))
	}
}
...
func (l *Logger) Debug(v ...interface{}) {
	if l.lv <= LevelDebug {
		l.lg.Output(3, fmt.Sprintf("[D] %s", fmt.Sprintln(v...)))
	}
}
...
func (l *Logger) Info(v ...interface{}) {
	if l.lv <= LevelInfo {
		l.lg.Output(3, fmt.Sprintf("[I] %s", fmt.Sprintln(v...)))
	}
}
...
func (l *Logger) Warn(v ...interface{}) {
	if l.lv <= LevelWarn {
		l.lg.Output(3, fmt.Sprintf("[W] %s", fmt.Sprintln(v...)))
	}
}
...
func (l *Logger) Error(v ...interface{}) {
	if l.lv <= LevelError {
		l.lg.Output(3, fmt.Sprintf("[E] %s", fmt.Sprintln(v...)))
	}
}
...
func (l *Logger) Fatal(v ...interface{}) {
	if l.lv <= LevelFatal {
		l.lg.Output(3, fmt.Sprintf("[F] %s", fmt.Sprintln(v...)))
		os.Exit(1)
	}
}
